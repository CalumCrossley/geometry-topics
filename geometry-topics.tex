...
\begin{enumerate}
    ...
    \item Show that $\RP^2\#\RP^2\#\RP^2$ and $T^2\#\RP^2$ are homeomorphic.
        ...
        \end{equation*}
        are homeomorphic, but $(S^2\times S^2)\#\CP^2$ is homeomorphic to
        $\CP^2\#\overline{\CP^2}\#\overline{\CP^2}$.
    ...
    \item Let $X$ be the 4-manifold corresponding to the $A_2$ graph
        \dynkin{A}{2}. Show that $\pi_1(X)=\Z/3$.
...
% wrap-up: mention Y^3,X^4 convention, say some stuff about surgery and handle attachment
