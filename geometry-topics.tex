...
\begin{proof}[Solution]
    ...
    \begin{equation*}
        \int_{\Gr(2,\C^4)}c_4(\Sym^3\U^*)
            ...
            = 27
    \end{equation*}
    sicne the integral of $\omega$ is the intersection number of $\Gr(2,\C^4)$
...
\begin{exercise}
    ...
    that $s$ defines a section of $\Sym^3\U^*\to\Gr(2,\C^4)$ cutting out the
    lines in $\P^3$ which lie in $S$, of which there are hence 27.
\end{exercise}
